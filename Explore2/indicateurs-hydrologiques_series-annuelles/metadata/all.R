...
META$title = "Séries annuelles d'indicateurs issus des projections hydrologiques Explore2 du débit pour le modèle {HM} sous {RCP}"
...
META$kindOfDataOther = "Séries annuelles (débit)"
