...
META$title = "Séries par horizons temporels d'indicateurs issus des projections hydrologiques Explore2 du débit pour le modèle {HM} sous {RCP}"
...
META$kindOfDataOther = "Séries par horizons temporels (débit)"
...
META$relatedDatasetCitation = "{citation}"
META$relatedDatasetIDType = "doi"
META$relatedDatasetIDNumber = "{DOI}"
META$relatedDatasetURL = "{URL}"
