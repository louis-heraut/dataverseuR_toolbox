...
META$title = "Séries par horizons temporels d'indicateurs issus des simulations hydrologiques Explore2 du débit pour l'ensemble des modèles hydrologiques sous la réanalyse SAFRAN"
...
META$dsDescriptionValue = "Séries par horizons temporels d'indicateurs des débits journaliers issus des 9 modèles hydrologiques Explore2 pour la réanalyse SAFRAN. Ces fichiers NetCDF sont disponibles au téléchargement dans la collection <a href='https://entrepot.recherche.data.gouv.fr/dataverse/explore2-projections_hydrologiques'>Explore2 - Projections hydrologiques</a>.<br><br>
...
&#8594; {1}_{2}_{3} <i>Série</i> : Série d'une variable pour un horizon temporel, défini dans le <a href='https://doi.org/10.57745/JVNHQL'>récapitulatif des indicateurs hydrologiques</a><br>
...
{9} <i>utur</i> : Période futur (fut-YYYYMMDD-YYYYMMDD)<br><br>
...
<li><i>date</i> : (optionnelle) Date associée à l'agrégation (plus d'information dans les métadonnées de variable)</li>
<li><i>*variable*</i> : Variable(s) définie(s) dans le <a href='https://doi.org/10.57745/JVNHQL'>récapitulatif des indicateurs hydrologiques</a></li>"
...
META$kindOfDataOther = "Séries par horizons temporels (débit) - SAFRAN"
