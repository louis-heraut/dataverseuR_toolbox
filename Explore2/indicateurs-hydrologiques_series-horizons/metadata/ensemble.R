...
META$title = "Ensemble des séries par horizons temporels d'indicateurs issus des projections hydrologiques Explore2 du débit"
META$alternativeTitle = "Collection Explore2 - Indicateurs hydrologiques / Séries par horizons temporels"

META$alternativeURL = "https://entrepot.recherche.data.gouv.fr/dataverse/explore2-indicateurs_hydrologiques-series_horizons"
...
META$kindOfDataOther = "Séries par horizons temporels (débit) - Ensemble"
...
META$relatedDatasetIDNumber = "10.57745/YHMBHC"
META$relatedDatasetURL = "https://doi.org/10.57745/YHMBHC"
