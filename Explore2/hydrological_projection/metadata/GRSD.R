...
META$title = "Projections hydrologiques Explore2 du débit pour le modèle GRSD sous {RCP}"

META$alternativeURL = "https://www.drias-eau.fr/commande"

META$datasetContactName = "Thirel, Guillaume"
...
META$authorName1 = "Thirel, Guillaume"
...
META$authorName2 = "Perrin, Charles"
...
META$authorName3 = "Strohmenger, Laurent"
