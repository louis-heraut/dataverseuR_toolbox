...
path_to_data =
    "/media/lheraut/Explore2/hydrological-projections_indicators/hydrological-projections_indicators_changes-by-horizon-ref-1976-2005_by-chain_parquet/narratifs_all/"
