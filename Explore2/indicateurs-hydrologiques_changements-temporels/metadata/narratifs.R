...
META$title = "Ensemble des changements par horizons temporels d'indicateurs issus des narratifs des projections hydrologiques Explore2 du débit (référence 1976-2005)"
...
META$kindOfDataOther = "Changements par horizons temporels (débit) - Narratifs"
