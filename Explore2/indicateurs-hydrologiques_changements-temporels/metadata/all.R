...
META$title = "Indicateurs de changements par horizons temporels issus des projections hydrologiques Explore2 du débit pour le modèle {HM} sous {RCP} (référence 1976-2005)"
