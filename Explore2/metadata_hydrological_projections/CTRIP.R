...
META$title = "Projections hydrologiques Explore2 du débit pour le modèles CTRIP sous {RCP}"
...
META$dsDescriptionValue = "Débit journalier simulé par le modèle hydrologique CTRIP pour l'ensemble des projections climatiques Explore2 sous {RCP}. Ces projections sont concaténées temporellement avec la partie historique commune à chaque RCP.<br><br>
