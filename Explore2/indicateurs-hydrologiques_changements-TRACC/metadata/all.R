...
<b>Définition des 4 narratifs hydrologiques</b> :<br>
L'ensemble des descriptions des narratifs hydrologique définit dans le cadre de la TRACC par niveau de réchauffement est défini ici : <a href='https://doi.org/10.57745/KAHIWJ'>https://doi.org/10.57745/KAHIWJ</a>.<br><br>
...
META$kindOfDataOther = "Changements par niveaux de réchauffement TRACC (débit)"
